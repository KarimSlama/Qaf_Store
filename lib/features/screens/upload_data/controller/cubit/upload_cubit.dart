...
class UploadCubit extends Cubit<UploadState> {
  ...
  UploadCubit(this.categoriesRepository, this.productsRepository,
      this.bannersRepository, this.brandsRepository)
  ...
  //     },
  //     failure: (error) {
  //       print('upload categoreis error $error');
  ...
  //   final result = await bannersRepository.uploadBanners(DummyData.banners);
  //   result.when(
  //     success: (data) {
  //       // emit(UploadState.bannerSuccess());
  //     },
  //     failure: (error) {
  //       print('upload banners error $error');
  ...
  //   final result = await productsRepository.uploadProducts(DummyData.products);
  //   result.when(
  //     success: (data) {
  //       emit(UploadState.productSuccess());
  //     },
  //     failure: (error) {
  //       print('upload products error $error');
  ...
  //   final result = await brandsRepository.uploadBrands(DummyData.brands);
  //   result.when(
  //     success: (data) {
  //       emit(UploadState.brandsSuccess());
  //     },
  //     failure: (error) {
  //       print('upload brands error $error');
