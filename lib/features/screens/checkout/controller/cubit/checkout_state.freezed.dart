...
class _$CheckoutStateImpl implements _CheckoutState {
  const _$CheckoutStateImpl({required this.selectedPaymentMethod});
  ...
  @override
  String toString() {
    return 'CheckoutState(selectedPaymentMethod: $selectedPaymentMethod)';
  }
...
abstract class _CheckoutState implements CheckoutState {
  const factory _CheckoutState(
          {required final PaymentMethodModel selectedPaymentMethod}) =
      _$CheckoutStateImpl;
