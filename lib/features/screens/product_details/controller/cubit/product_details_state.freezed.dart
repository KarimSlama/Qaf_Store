...
abstract class Initial<T> implements ProductDetailsState<T> {
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'ProductDetailsState<$T>.success(image: $image)';
  }
...
abstract class Success<T> implements ProductDetailsState<T> {
  const factory Success(final String image) = _$SuccessImpl<T>;
